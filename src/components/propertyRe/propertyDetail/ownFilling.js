export default {
  data() {
    return {
      ...
      pownslist: ["{'goodsname':'','goodsnum':[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}, {goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''},{goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}",
      "{'goodsname':'','goodsnum':[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}, {goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''},{goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}",
      "{'goodsname':'','goodsnum':[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}, {goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''},{goodsname:'',goodsnum:[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}"],
      rules: {
        insperson: [{
          required: true,
      ...
      imageUrl: '',
      pownslist:[1,2],
      baseList:{'goodsname':'','goodsnum':[1,2,3],goodsunit:'',goodsbox:'',goodslevel:'',goodsdes:'',goodsimgbox:''}
    };
  },
  methods: {
    // 上传图片
